...
function handleChange() {
    ...
    counter = 1
    renderBoxes()
    var openModalButtons = document.querySelectorAll(".open")
    clickOpenModal(openModalButtons)
}
...
var openModalButtons = document.querySelectorAll(".open") //adding a data attribute to a rect does not work, so refer to the "open" class
const closeModalButtons = document.querySelectorAll('[data-close-button]')
const overlay = document.getElementById('overlay')

function clickOpenModal(openModalBtns) {
  openModalBtns.forEach(button => { //open the modal when a square is clicked
